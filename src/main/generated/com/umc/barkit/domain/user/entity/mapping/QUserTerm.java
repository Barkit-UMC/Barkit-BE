...
public class QUserTerm extends EntityPathBase<UserTerm> {
    ...
    private static final long serialVersionUID = 1178675470L;
    ...
    public final com.umc.barkit.domain.user.entity.QTerm term;
    ...
    public QUserTerm(Class<? extends UserTerm> type, PathMetadata metadata, PathInits inits) {
        ...
        this.term = inits.isInitialized("term") ? new com.umc.barkit.domain.user.entity.QTerm(forProperty("term")) : null;
